            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                    <div class="shop-menu pull-right">
                        <ul class="nav navbar-nav">
                            <li><a href="<?php echo site_url('profile'); ?>"><i class="fa fa-user"></i> Your account</a>
                            </li>
                            <li><a href="<?php echo site_url('cart'); ?>"><i class="fa fa-shopping-cart"></i> Your cart
                                    <span
                                        class="cart-items"><?php echo !empty($cart) ? '(' . count($cart) . ')' : ''; ?></span></a>
                            </li>
                            <?php if (!empty($user)) { ?>
                                <li><a href="<?php echo site_url('user'); ?>"><i class="fa fa-lock"></i> Profile</a></li>
                            <?php } else { ?>
                                <li><a href="<?php echo site_url('user/login'); ?>"><i class="fa fa-lock"></i> Login / Registration</a></li>
                            <?php } ?>
                        </ul>
                    </div>
                </div>
